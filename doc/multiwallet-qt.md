...
In order to support loading of multiple wallets in tixoncash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is tixoncash.cpp.
...
Changes to tixoncash.cpp
----------------------
tixoncash.cpp is the entry point into tixoncash-qt, and as such, will require some minor modifications to provide hooks for
