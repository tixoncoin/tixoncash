...
This mechanism has been integrated into Bitcore-Node-Tixoncash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/tixoncash/insight-api-tixoncash#web-socket-api](https://github.com/tixoncash/insight-api-tixoncash#web-socket-api)
* API: [https://github.com/tixoncash/insight-api-tixoncash#swifttx-transactions](https://github.com/tixoncash/insight-api-tixoncash#swifttx-transactions)
...
By default, the Tixoncash Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Tixoncash Core daemon:
