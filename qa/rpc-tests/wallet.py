...
#   c) node1 mines 32 blocks, so now node 0 has 500000TXCH, node 1 has 4250TXCH, node2 has none.
#   d) node0 sends 601 TXCH to node2, in two transactions (301 TXCH, then 300 TXCH).
