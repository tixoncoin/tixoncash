...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Tixoncash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Tixoncash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Tixoncash features */
        {"tixoncash", "masternode", &masternode, true, true, false},
        {"tixoncash", "listmasternodes", &listmasternodes, true, true, false},
        {"tixoncash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tixoncash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tixoncash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tixoncash", "masternodedebug", &masternodedebug, true, true, false},
        {"tixoncash", "startmasternode", &startmasternode, true, true, false},
        {"tixoncash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tixoncash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tixoncash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tixoncash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tixoncash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tixoncash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tixoncash", "mnbudget", &mnbudget, true, true, false},
        {"tixoncash", "preparebudget", &preparebudget, true, true, false},
        {"tixoncash", "submitbudget", &submitbudget, true, true, false},
        {"tixoncash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tixoncash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tixoncash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tixoncash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tixoncash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tixoncash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tixoncash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tixoncash", "checkbudgets", &checkbudgets, true, true, false},
        {"tixoncash", "mnsync", &mnsync, true, true, false},
        {"tixoncash", "spork", &spork, true, true, false},
        {"tixoncash", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"tixoncash", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"tixoncash", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"tixoncash", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"tixoncash", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"tixoncash", "mncommunityvote", &mncommunityvote, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> tixoncash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:9432/\n";
}
