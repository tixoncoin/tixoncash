...
#if defined(NDEBUG)
#error "Tixoncash cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in utxch) are considered zero fee (for relaying and mining)
...
{
    RenameThread("tixoncash-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // TXCH: We use certain sporks during IBD, so check to see if they are
