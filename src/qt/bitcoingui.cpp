                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Tixoncash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TXCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tixoncash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Tixoncash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Tixoncash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Tixoncash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TXCH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TXCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a tixoncash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Tixoncash Core help message to get a list with possible Tixoncash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Tixoncash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Tixoncash network", "", count));
}
...
{
    QString strTitle = tr("Tixoncash Core"); // default title
