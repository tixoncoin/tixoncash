...
/** Utility functions used by the Tixoncash Qt UI.
 */
namespace GUIUtil
{
...
// Render TXCH addresses in monospace font
...
// Parse "tixoncash:" URI into recipient object, return true on successful parsing
