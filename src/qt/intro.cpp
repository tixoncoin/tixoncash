...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Tixoncash Core"),
     ...
     * override -datadir in the tixoncash.conf file in the default data directory
     * (to be consistent with tixoncashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
