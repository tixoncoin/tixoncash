...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/tixoncash-cli.cpp \
           src/tixoncash-tx.cpp \
           src/tixoncash.cpp \
           src/db.cpp \
           ...
           src/qt/tixoncash.cpp \
           src/qt/tixoncashstrings.cpp \
...
RESOURCES += src/qt/tixoncash.qrc src/qt/tixoncash_locale.qrc

TRANSLATIONS += src/qt/locale/tixoncash_bg.ts \
                src/qt/locale/tixoncash_de.ts \
                src/qt/locale/tixoncash_en.ts \
                src/qt/locale/tixoncash_es.ts \
                src/qt/locale/tixoncash_fi.ts \
                src/qt/locale/tixoncash_fr.ts \
                src/qt/locale/tixoncash_it.ts \
                src/qt/locale/tixoncash_ja.ts \
                src/qt/locale/tixoncash_pl.ts \
                src/qt/locale/tixoncash_pt.ts \
                src/qt/locale/tixoncash_ru.ts \
                src/qt/locale/tixoncash_sk.ts \
                src/qt/locale/tixoncash_sv.ts \
                src/qt/locale/tixoncash_vi.ts \
                src/qt/locale/tixoncash_zh_CN.ts \
                src/qt/locale/tixoncash_zh_TW.ts
