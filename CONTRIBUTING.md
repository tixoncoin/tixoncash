...
The following applies to code changes to the Tixoncash Core project, and is not to be
confused with overall Tixoncash Network Protocol consensus changes.

Whether a pull request is merged into Tixoncash Core rests with the project merge
...
Patches that change Tixoncash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Tixoncash consensus, it must have been
...
The project leader is the release manager for each Tixoncash Core release.
